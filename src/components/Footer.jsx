    ...
    <section className="bg-[#F0D9B7] mt-auto">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-6 text-black">
          ...
          <a href="https://www.instagram.com/7sensesintegrationcentre?igsh=cWtjNTVnOGlyYTV0&utm_source=qr" target="_blank" className=" hover:text-gray-500">
      ...
      <p className="py-8 text-base leading-6 text-center text-[#61677A] font-semibold bg-[#E5C59F]">
        Copyright © 2024, Seven Senses Integration Centre
      </p>
    </section>
  );
};
